...
This document describes how to copy and customise the emil2016 (bootstrapbase) theme so that
...
From your Moodle theme directory right click on emil2016 and then copy and paste back
into your Moodle theme directory. You should now have a folder called Copy of emil2016.
...
underscores. For the purpose of this tutorial we will call the theme 'emil2016theme'.

On opening 'emil2016theme' your you will find several files and sub-directories which have
files within them.
...
where the old theme name occurs, in this case emil2016. So using the above list as
a guide, search through and change all the instances of the theme name
'emil2016' to 'emil2016theme'. This includes the filename of the lang/en/theme_emil2016.php.
You need to change this to 'theme_emil2016theme.php'.
...
and then click on (emil2016theme) or whatever you renamed your theme to,
from the list of theme names that appear at this point in the side block.

Customisation using custom theme settings
-----------------------------------------

The settings page for the emil2016 theme can be located by navigating to:

Administration > Site Administration > Appearance > Themes > emil2016

Moodle documentation
--------------------

Further information can be found on Moodle Docs: http://docs.moodle.org/dev/emil2016_theme
